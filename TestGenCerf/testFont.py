...
pdfmetrics.registerFont(TTFont("DancingScript-VariableFont_wght", "DancingScript-VariableFont_wght.ttf"))
...
def create_certificate(output_path, name, course):
    ...
    pdf.drawCentredString(width / 2, height / 2, name)

    # เพิ่มรายละเอียดหลักสูตร
    pdf.setFont("DancingScript-VariableFont_wght", 36)
...
create_certificate("certificateFont.pdf", "GOD Good ", "Basic : Python")
