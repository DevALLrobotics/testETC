...
def create_certificate(output_path, name, course):
    ...
    pdf.setFont("THSarabunNew", 36)
    pdf.drawCentredString(width / 2, height / 2 - 60, f"ผ่านการอบรมหลักสูตร {course}")
...
create_certificate("certificateTH.pdf", "สมชาย ใจดี", "หลักสูตร Python ขั้นสูง")
