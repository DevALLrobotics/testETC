...
def create_certificate(output_path, name, course):
    ...
    pdf.drawCentredString(width - 200, height / 2, name)

    # เพิ่มข้อความรายละเอียด
    pdf.setFont("Helvetica", 24)
    pdf.drawCentredString(width - 460, height / 2 - 50, f"the asdddfghj  :  {course}")
...
create_certificate("test.pdf", "Titiwut", "Test")
